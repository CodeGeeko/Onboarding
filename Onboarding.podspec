...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kuldeepbhatt/Onboarding'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kuldeepbhatt' => 'bhatt.it2010@gmail.com' }
  s.source           = { :git => 'https://github.com/kuldeep-dvt/Onboarding.git', :tag => s.version.to_s }
  ...
  # s.frameworks = 'UIKit', 'MapKit'
   ...
   s.dependency 'MaterialComponents/Chips'
end
